...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request,'Thank you, We have sent verification to your email. Please verify it.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # getting the product variations vy cart id
                    ...
                    # getting the items from user to his product variations
...
def resetpassword_validate(request,uidb64,token):
    ...
    if user is not None and default_token_generator.check_token(user,token):
        ...
        messages.success(request,'Please reset your new password')
